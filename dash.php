...
<title>TEST HUB - DASHBOARD </title>
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Quiz title" class="form-control input-md quiz-detail" type="text">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Enter total number of questions" class="form-control input-md quiz-detail" type="number">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter marks on right answer" class="form-control input-md quiz-detail" min="0" type="number">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Enter minus marks on wrong answer without sign" class="form-control input-md quiz-detail" min="0" type="number">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Enter time limit for test in minute" class="form-control input-md quiz-detail" min="1" type="number">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="Enter #tag which is used for searching" class="form-control input-md quiz-detail" type="text">
...
<div class="form-group ">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control quiz-detail" placeholder="Write description here..."></textarea>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-12"> 
    <input  type="submit" style="margin-left:45%" class="btn quiz-detail-btn" value="Submit" class="btn btn-primary"/>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="qns'.$i.'" class="form-control quiz-detail" placeholder="Write question number '.$i.' here..."></textarea>  
  </div>
</div>
<!-- Text input-->
<div class="form-group">
...
<select id="ans'.$i.'" name="ans'.$i.'" placeholder="Choose correct answer " class="form-control input-md" >
  ...
  <option value="d">option d</option> </select><br /><hr class="hr"><br />'; 
